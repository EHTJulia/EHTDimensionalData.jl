...
will be overwritten. `DimArray`s in the concatenated `DimStack` data set are 
programmatically indistinguishable from those in the original `DimStack` data sets.
"""
